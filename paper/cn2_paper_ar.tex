...
مع متجه (Hessian-vector products) بحيث لا تكون نيوتن الكاملة ضرورية؛ (ب) إثبات تقارُب
متين لتتابع النقاط $\{x_{jK}\}$ والاضمحلال ذي الطورين لانحطاط نيوتن؛ (ج) نشر حزمة
مفتوحة المصدر قابلة للإعادة.
